...
transformed parameters {
    ...
    ALPHA = alpha;
    //ALPHA[7] = (alpha[7]+alpha[J[1]+5])/2;
    //ALPHA[J[1]+5] = ALPHA[7];
    //ALPHA[9] = (alpha[9]+alpha[J[1]+7])/2;
    //ALPHA[J[1]+7] = ALPHA[9];
    //ALPHA[10] = (alpha[10]+alpha[J[1]+8])/2;
    //ALPHA[J[1]+8] = ALPHA[10];
    //ALPHA[17] = (alpha[17]+alpha[J[1]+18])/2;
    //ALPHA[J[1]+18] = ALPHA[17];
    //ALPHA[18] = (alpha[18]+alpha[J[1]+20])/2;
    //ALPHA[J[1]+20] = ALPHA[18];
    //ALPHA[20] = (alpha[20]+alpha[J[1]+22])/2;
    //ALPHA[J[1]+22] = ALPHA[20];
    BETA = beta;
